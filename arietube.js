...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': {
                m.reply('Script : https://github.com/FADHLURAHMAN122\n\n Jangan lupa donasi ya kak\n\nDonasi : https://sociabuzz.com/FDLMODZZ/tribe')
            }
            break
            case 'chat': {
...
■■■■■ 100%
╔═══❖•ೋ°
╟ WELCOME TO FDLMODZZ BOT
╟    SILAHKAN PILIH MENUNYA
╟👨‍👨‍👧‍👧*GC BOT:*
╟https://chat.whatsapp.com/BSzvqFTNFSIDasJMKpA6pV
╚═══❖•ೋ°
╔═.✵.════ 𝐆𝐑𝐔𝐏 𝐌𝐄𝐍𝐔 ❊╌──┈⊰᯽⊱
╟📤 ${prefix}linkgroup
...
╚═════ ▓▓ ࿇`
                let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://github.com/FADHLURAHMAN122'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+6289604092736'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Status Bot',
